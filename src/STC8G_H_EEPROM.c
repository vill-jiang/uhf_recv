...
//========================================================================
// 函数: void EEPROM_read_n(uint16_t EE_address,uint8_t *DataAddress,uint16_t number)
...
//========================================================================
// 函数: void EEPROM_SectorErase(uint16_t EE_address)
// 描述: 把指定地址的EEPROM扇区擦除.
...
//========================================================================
// 函数: void EEPROM_write_n(uint16_t EE_address,uint8_t *DataAddress,uint16_t number)
